...
use agent_client_protocol_schema::{
    ListSessionsRequest, ListSessionsResponse, SetSessionModelRequest, SetSessionModelResponse,
};
...
pub trait Agent {
    ...
    ///
    /// This method allows clients to discover previously created sessions that can be resumed.
    /// Agents that support this capability advertise it via `listSession` in their capabilities.
    ///
    /// See protocol docs: [Session List](https://agentclientprotocol.com/protocol/session-setup#listing-sessions)
    #[cfg(feature = "unstable")]
