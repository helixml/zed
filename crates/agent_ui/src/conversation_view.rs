    ...
    pub fn from_existing_thread(
        ...
        Self {
            ...
            server_state: ServerState::Connected(ConnectedServerState {
                ...
                // HELIX: headless/external threads have no elicitation UI to
                // drive, so there is nothing to subscribe to. Upstream added
                // this field in the 2026-07 elicitation work.
            ...
            this.update_in(cx, |this, window, cx| {
                match result {
                    Ok(thread) => {
                        ...
                        #[cfg(feature = "external_websocket_sync")]
                        {
                            let session_id = root_session_id.to_string();
